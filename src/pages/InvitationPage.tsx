...
function SeudeumePage() {
  return (
    <div className="w-140 h-full p-14">
      ...
      <div className="pb-20">
        <p className="mt-5 text-black text-2xl font-bold leading-normal">스마트한 축의금 페이지</p>
      ...
      <div>
        <p className="flex justify-center mt-28 text-black text-3xl font-bold ">결제하지 마세요!</p>
